...
class CustomerResourceIT {
    ...
    private static final String[] EXAMPLE_CUSTOMERS = {
            "Thomas Danzig",
            "Petra Heisenberg",
            "Vincent Vega",
            "Jeff Sciarra",
    ...
    void shouldCreateNewCustomer() throws Exception {
        final CustomerCreationDto dto = CustomerCreationDto
                .builder()
                .firstName("Daniel")
                .lastName("Kaiser")
        ...
        final List<String> insuranceNumbers = customerRepository
                .findAll()
                .stream()
    ...
    void shouldRetrieveExistingCustomer() throws Exception {
        ...
        final String insuranceNumber = customerRepository
                .findByName(thomas_danzig)
                .map(Customer::getInsuranceNumber)
                .orElseThrow();
        ...
        mvc
                ...
                .andExpect(jsonPath("$.paymentRate").value(equalTo(264.0)));
    }
    ...
    void shouldRetrieveAllCustomers() throws Exception {
        mvc
                ...
                .andExpect(
                        jsonPath("$.[*].insuranceNumber").value(hasItems(hasLength(8)))
                )
                .andExpect(
                ...
                .andExpect(
                        jsonPath("$.[*].paymentRate")
                                .value(
                                        hasItems(allOf(greaterThanOrEqualTo(0.0), lessThanOrEqualTo(300.0)))
                                )
                );
    }
}

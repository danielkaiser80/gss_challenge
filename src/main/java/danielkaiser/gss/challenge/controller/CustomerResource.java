...
public class CustomerResource {
  ...
  @Operation(
    ...
    description = "Create a new customer with the given information and return his insurance number."
  )
  @ApiResponses(
    value = {
      @ApiResponse(
        responseCode = "201",
        description = "Successful created, insurance number returned.",
        content = @Content(
          mediaType = APPLICATION_JSON_VALUE,
          schema = @Schema(implementation = InsuranceNumberDto.class),
      ...
      @ApiResponse(
        ...
        content = @Content(
          ...
          examples = @ExampleObject(value = "Input data is not valid.")
        )
      ),
    }
  )
  ...
  public ResponseEntity<InsuranceNumberDto> createCustomer(
    @io.swagger.v3.oas.annotations.parameters.RequestBody(
      content = @Content(
        mediaType = APPLICATION_JSON_VALUE,
        schema = @Schema(implementation = CustomerCreationDto.class),
        examples = @ExampleObject(
          value = """
          {
            "firstName": "Daniel",
    ...
    final CustomerCreatedDto result = customerService.createCustomer(
      customerCreationDto
    );
    return ResponseEntity
      .created(new URI("/api/customers/" + result.id()))
      .body(InsuranceNumberDto.of(result.insuranceNumber()));
  }

  @Operation(
    summary = "Retrieve a customer",
    description = "Retrieve a customer using his insurance number."
  )
  @ApiResponses(
    value = {
      @ApiResponse(
        ...
        content = @Content(
          ...
          examples = @ExampleObject(value = CUSTOMER_EXAMPLE)
        )
      ),
      @ApiResponse(
        responseCode = "404",
        description = "No customer with the supplied insurance number exists.",
        content = @Content(mediaType = ALL_VALUE, examples = @ExampleObject)
      ),
    }
  )
  ...
  public ResponseEntity<CustomerDto> findCustomer(
    @Parameter(
      description = "The insurance number",
      examples = { @ExampleObject(value = "58e71225") }
  ...
  @Operation(
    ...
    description = "Retrieve all customers with payment information as a list."
  )
  @ApiResponses(
    value = {
      @ApiResponse(
